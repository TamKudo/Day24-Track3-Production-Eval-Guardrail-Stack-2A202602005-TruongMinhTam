...
def pii_scan(text: str, analyzer=None, anonymizer=None) -> dict:
    ...
    # PERSON dùng spaCy NER tiếng Anh — không đáng tin với văn bản tiếng Việt,
    # hay false-positive trên cụm danh từ tiếng Việt (vd "nghỉ phép năm 2024").
    results = [r for r in results if r.entity_type != "PERSON"]
    if not results:
...
if __name__ == "__main__":
    ...
    print("\nGuard report saved → reports/guard_results.json")
